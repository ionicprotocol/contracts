...
contract StakingController is Initializable {
  ...
  function initialize(VeIonicToken _veToken, IonicToken _ionicToken) public initializer {
    veToken = _veToken;
  ...
  function stake(uint256 amountToStake) public {
    ...
    ionicToken.transferFrom(msg.sender, address(this), amountToStake);
  ...
  function unstake(address account) public {
    ...
    ionicToken.transfer(account, amountToUnstake);
